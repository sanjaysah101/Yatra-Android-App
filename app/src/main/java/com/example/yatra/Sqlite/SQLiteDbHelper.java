...
public class SQLiteDbHelper extends SQLiteOpenHelper {
    ...
    public void addNewData(String name, String image, Integer quantity, Integer price) {
    ...
    public ArrayList<RecyclerItemInCartModel> readData(Context context) {
        ...
        ArrayList<RecyclerItemInCartModel> ProductArrayList = new ArrayList<>();
        ...
        if (cursorCourses != null) {
            if (cursorCourses.moveToFirst()) {
                do {
                    ...
                    ProductArrayList.add(new RecyclerItemInCartModel(cursorCourses.getInt(0),
